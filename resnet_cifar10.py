...
class EarlyStopping:
    def __init__(self, patience=10, threshold=1e-5):
...
def main():
    ...
    writer = SummaryWriter('runs/cifar10_experiment_b256')
    ...
    scheduler = ReduceLROnPlateau(optimizer, 'min', factor=0.1, patience=10, threshold=0.025, min_lr=1e-5)
